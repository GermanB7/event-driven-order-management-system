...
class MarkOrderPaymentPendingUseCaseTest {

    private OrderRepository orderRepository;
    private MarkOrderPaymentPendingUseCase useCase;

    @BeforeEach
    void setUp() {
        orderRepository = mock(OrderRepository.class);
        useCase = new MarkOrderPaymentPendingUseCase(orderRepository);
    }

    @Test
    void marksInventoryPendingOrderAsPaymentPending() {
        ...
        assertThat(captor.getValue().status()).isEqualTo(OrderStatus.PAYMENT_PENDING);
    }
}
