...
class MarkOrderCancelledUseCaseTest {

    private OrderRepository orderRepository;
    private MarkOrderCancelledUseCase useCase;

    @BeforeEach
    void setUp() {
        orderRepository = mock(OrderRepository.class);
        useCase = new MarkOrderCancelledUseCase(orderRepository);
    }

    @Test
    void marksPaymentPendingOrderAsCancelled() {
