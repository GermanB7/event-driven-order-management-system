...
@Service
public class MarkOrderFulfillmentRequestedUseCase {

    private final OrderRepository orderRepository;

    public MarkOrderFulfillmentRequestedUseCase(OrderRepository orderRepository) {
    ...
    public void execute(UUID orderId) {
        ...
        Order updatedOrder = order.markFulfillmentRequested(Instant.now());
