...
@Service
public class MarkOrderConfirmedUseCase {

    private final OrderRepository orderRepository;

    public MarkOrderConfirmedUseCase(OrderRepository orderRepository) {
    ...
    public void execute(UUID orderId) {
        ...
        Order updatedOrder = order.markConfirmed(Instant.now());
