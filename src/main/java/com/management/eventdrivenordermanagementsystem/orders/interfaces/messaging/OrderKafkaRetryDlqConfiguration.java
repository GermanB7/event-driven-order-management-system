...
@Configuration
public class OrderKafkaRetryDlqConfiguration {

    private static final Logger log = LoggerFactory.getLogger(OrderKafkaRetryDlqConfiguration.class);

    @Bean("orderWorkflowKafkaListenerContainerFactory")
    ConcurrentKafkaListenerContainerFactory<String, String> orderWorkflowKafkaListenerContainerFactory(
        ...
        errorHandler.addNotRetryableExceptions(NonRetryableOrderMessageException.class);
